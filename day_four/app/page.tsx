...
const page = () => {
	const links = [
		...
		{
			icon: (
				<Image src={"umbrella-2.svg"} alt="odne" width={50} height={50} />
			),
		},
	];
	return (
		<div className="w-full h-full relative [--pattern-fg:var(--color-neutral-900)]/9  flex justify-center items-center bg-neutral-500  ">
			<div className="h-80 w-60 shadow-input rounded-xl bg-neutral-200 overflow-hidden z-10  border-2 border-neutral-300  ">
